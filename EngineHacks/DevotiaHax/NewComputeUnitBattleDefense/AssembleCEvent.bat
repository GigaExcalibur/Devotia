...
SET ref="C:\Users\jlevi\OneDrive\Documents\GitHub\Devotia\Tools\FE-Clib\reference\FE8U-20190316"
SET lyn="C:\devkitPro\lyn.exe"

@rem compile into an object file
%gcc% -mcpu=arm7tdmi -mabi=aapcs -mthumb -mthumb-interwork -fomit-frame-pointer -ffast-math -fno-toplevel-reorder -mlong-calls -I "C:\Users\jlevi\OneDrive\Documents\GitHub\Devotia\Tools\FE-Clib\include" -O0 -c %1 -o "%~n1.o"
